...
const EXPOSURE_GROUPS = {
  ...
  '8': { name: 'S그룹', description: 'S 등급 회원' },
  '9': { name: 'O그룹', description: 'O 등급 회원' },
  '10': { name: 'P그룹', description: 'P 등급 회원' },
  '11': { name: 'E그룹', description: 'E 등급 회원' },
  '12': { name: 'X그룹', description: 'X 등급 회원' },
};
